...
@protocol WYSegmentControlViewDelegate <NSObject>

- (void)didClickedOneIndex:(NSInteger )curentIndex;

@end

@interface WYSegmentControlView : UIView
...
@property (nonatomic,weak)id<WYSegmentControlViewDelegate> delegate;
